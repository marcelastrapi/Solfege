...
public:
    Instrument();
    Instrument( const Note &note, const sf::Time &time , InstrumentName instrumentName = Sinusoide);
...
public :
    ...
    void setInstrumentName(const InstrumentName newInstrumentName);

private :
    /// \brief Initialise the sound_buffer, depending of the instrumentName choosen
